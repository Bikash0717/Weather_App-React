//using the icons images as provided by openweathermap api
...
if(city==="")
{
  ...
  console.log(datas);
  const icon=`https://openweathermap.org/img/wn/${datas.weather[0].icon}.png`
  setweatherdetail({
...
//using own icons as according to the icon code provided by the openweathermap api
